...
const TaskScheduler = () => {
  ...
  const tasks = [
    { id: 1, title: "Morning medication", patient: "Margaret Smith", time: "08:00 AM", completed: true },
    { id: 2, title: "Lunch reminder", patient: "John Davies", time: "12:30 PM", completed: false },
    { id: 3, title: "Evening walk", patient: "Patricia Wilson", time: "05:00 PM", completed: false },
    { id: 4, title: "Blood pressure check", patient: "Margaret Smith", time: "06:00 PM", completed: false },
  ];
