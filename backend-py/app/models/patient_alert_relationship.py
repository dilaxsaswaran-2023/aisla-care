...
class PatientAlertRelationship(Base):
	__tablename__ = "patient_alert_relationships"
...
BudiiAlertRelationship = PatientAlertRelationship

__all__ = ["PatientAlertRelationship", "BudiiAlertRelationship"]
